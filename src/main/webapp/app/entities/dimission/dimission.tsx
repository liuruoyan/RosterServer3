    ...
    return (
      <div>
        <h2 id="dimission-heading">
          <Translate contentKey="rosterServer3App.dimission.home.title">Dimissions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer3App.dimission.home.createLabel">Create new Dimission</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {dimissionList && dimissionList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="rosterServer3App.dimission.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('lastDate')}>
                    <Translate contentKey="rosterServer3App.dimission.lastDate">Last Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('reason')}>
                    <Translate contentKey="rosterServer3App.dimission.reason">Reason</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={this.sort('isHrVerify')}>
                    <Translate contentKey="rosterServer3App.dimission.isHrVerify">Is Hr Verify</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                  ...
                  <th>
                    <Translate contentKey="rosterServer3App.dimission.emp">Emp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer3App.dimission.home.notFound">No Dimissions found</Translate>
            </div>
          )}
        </div>
