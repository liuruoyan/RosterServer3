    ...
    return (
      <div>
        <h2 id="enum-emp-type-heading">
          <Translate contentKey="rosterServer3App.enumEmpType.home.title">Enum Emp Types</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer3App.enumEmpType.home.createLabel">Create new Enum Emp Type</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {enumEmpTypeList && enumEmpTypeList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('valuez')}>
                    <Translate contentKey="rosterServer3App.enumEmpType.valuez">Valuez</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('orderz')}>
                    <Translate contentKey="rosterServer3App.enumEmpType.orderz">Orderz</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('tenentCode')}>
                    <Translate contentKey="rosterServer3App.enumEmpType.tenentCode">Tenent Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="rosterServer3App.enumEmpType.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer3App.enumEmpType.home.notFound">No Enum Emp Types found</Translate>
            </div>
          )}
        </div>
