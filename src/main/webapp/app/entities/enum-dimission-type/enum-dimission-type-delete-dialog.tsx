  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rosterServer3App.enumDimissionType.delete.question">
          <Translate contentKey="rosterServer3App.enumDimissionType.delete.question" interpolate={{ id: enumDimissionTypeEntity.id }}>
