  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rosterServer3App.enumHighestEducation.delete.question">
          <Translate contentKey="rosterServer3App.enumHighestEducation.delete.question" interpolate={{ id: enumHighestEducationEntity.id }}>
