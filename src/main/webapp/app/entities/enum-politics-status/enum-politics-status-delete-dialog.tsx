  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rosterServer3App.enumPoliticsStatus.delete.question">
          <Translate contentKey="rosterServer3App.enumPoliticsStatus.delete.question" interpolate={{ id: enumPoliticsStatusEntity.id }}>
