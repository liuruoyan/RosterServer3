...
/**
 * Criteria class for the {@link com.cc.domain.EnumEducation} entity. This class is used
 * in {@link com.cc.web.rest.EnumEducationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-educations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumEducationCriteria implements Serializable, Criteria {
    ...
    public EnumEducationCriteria(){
    }

    public EnumEducationCriteria(EnumEducationCriteria other){
    ...
    @Override
    public EnumEducationCriteria copy() {
        return new EnumEducationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumEducationCriteria that = (EnumEducationCriteria) o;
        return
