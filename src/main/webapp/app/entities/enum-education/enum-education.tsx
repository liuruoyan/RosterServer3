    ...
    return (
      <div>
        <h2 id="enum-education-heading">
          <Translate contentKey="rosterServer3App.enumEducation.home.title">Enum Educations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer3App.enumEducation.home.createLabel">Create new Enum Education</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {enumEducationList && enumEducationList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('valuez')}>
                    <Translate contentKey="rosterServer3App.enumEducation.valuez">Valuez</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('orderz')}>
                    <Translate contentKey="rosterServer3App.enumEducation.orderz">Orderz</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th>
                    <Translate contentKey="rosterServer3App.enumEducation.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {enumEducationList.map((enumEducation, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      {enumEducation.parentId ? <Link to={`enum-education/${enumEducation.parentId}`}>{enumEducation.parentId}</Link> : ''}
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer3App.enumEducation.home.notFound">No Enum Educations found</Translate>
            </div>
          )}
        </div>
