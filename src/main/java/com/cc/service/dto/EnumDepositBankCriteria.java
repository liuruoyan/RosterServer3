...
/**
 * Criteria class for the {@link com.cc.domain.EnumDepositBank} entity. This class is used
 * in {@link com.cc.web.rest.EnumDepositBankResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-deposit-banks?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumDepositBankCriteria implements Serializable, Criteria {
    ...
    public EnumDepositBankCriteria(){
    }

    public EnumDepositBankCriteria(EnumDepositBankCriteria other){
    ...
    @Override
    public EnumDepositBankCriteria copy() {
        return new EnumDepositBankCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumDepositBankCriteria that = (EnumDepositBankCriteria) o;
        return
    ...
    public String toString() {
        return "EnumDepositBankCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
